import{Ca as P,qa as q,ra as g,za as A}from"./chunk-UVTSTIH3.js";import{Ab as M,Bb as w,Gb as l,Hb as D,Ib as F,Lb as f,Mc as Q,Nb as m,Ob as y,Pc as E,Qa as o,Rc as N,Sb as j,T as v,Tb as S,U as h,Yc as O,Z as T,Zb as z,ab as b,bb as C,eb as $,ga as p,gb as r,ob as i,rb as k,sb as I,uc as B,xb as u,yb as d,zb as x}from"./chunk-UUVLSZQE.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
