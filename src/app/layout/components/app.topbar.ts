    ...
    template: `<div class="layout-topbar">
        ...
        <div class="topbar-right">
            <ul class="topbar-menu">
                <li class="right-sidebar-item"></li>
                ...
                <li class="profile-item static sm:relative">
                    ...
                    >
                        <ul class="flex flex-col gap-1">
                            ...
                            <li>
                                <a class="label-small dark:text-surface-400 flex gap-2 py-2 px-2.5 rounded-lg items-center hover:bg-emphasis transition-colors duration-150 cursor-pointer" (click)="cerrarSecion()">
